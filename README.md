...
## ⁉️ не работает из коробки!! это веб версия, построенная на Rest, для использования желательно знать что и как. UI будет добавлен в будущих версиях, поддержка до 5 аккаунтов. Чтобы в данной версии все наботало - нужно настроить много всего, если хотите использовать уже сейчас - придется помучиться
